package teamzesa.Enumeration.Enhance.Items;
...
public enum EnhanceItemUndoInformation {
    ...
    private static final EnumMap<Material, EnhanceItemUndoInformation> CACHED_ITEM =
            Arrays.stream(values()).collect(
                    Collectors.toMap(
                        EnhanceItemUndoInformation::getMaterial,
                        Function.identity(),
                        (k1, k2) -> k1,
    ...
    EnhanceItemUndoInformation(Material material, ItemRarity itemRarity, ItemType itemType, boolean isMadeOfNetherite) {
    ...
    public static EnhanceItemUndoInformation findByMaterial(ItemStack itemStack) {
