...
import teamzesa.Event.Enhance.PlayerInteraction.UpdateItemLore.EnhanceItemLore;
...
//        todo CustomModelData 가 0 일 시 아이템 초기화 작업 로직
    ...
    public static Component getEnhanceStatusLore(ItemStack item) {
        ...
        return EnhanceItemLore.getEnhancementLoreByLevel(item.getItemMeta().getCustomModelData());
    }
