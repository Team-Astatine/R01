package teamzesa.Event.PlayerInteraction.PlayerStatus.PlayerJoinEvent;
...
import teamzesa.Event.RandomTeleport.RandomPositionGenerator;

import java.util.Arrays;
import java.util.Optional;

public class ImportPlayerStatus extends StringComponentExchanger implements EventRegister {
    ...
    public ImportPlayerStatus(PlayerJoinEvent event) {
        this.event = event;
        init();
        execute();
    }
